...
//User Module with roles & permissions
Route::group(['prefix' => 'mobile', 'middleware' => ['permission:manage-gymie|manage-users', 'auth']], function () {
    //User
    Route::group(['prefix' => 'settings'], function () {
        Route::get('/', 'MobileController@settings');
        Route::post('/update', 'MobileController@update');
    });
    Route::group(['prefix' => 'onboarding'], function () {
        Route::get('/', 'OnboardingController@index');
        Route::get('/create', 'OnboardingController@create');
        Route::post('/', 'OnboardingController@store');
        Route::get('{id}/edit', 'OnboardingController@edit');
        Route::post('{id}/update', 'OnboardingController@update');
        Route::post('{id}/delete', 'OnboardingController@delete');
...
Route::group(['prefix' => 'api/v1', 'middleware' => ['cors']], function () {
    Route::get('onboarding', 'Api\OnboardingController@index');
    Route::post('register', 'API\AuthController@register');
    Route::post('login', 'API\AuthController@login');
});
Route::group(['prefix' => 'api/v1', 'middleware' => ['jwt.auth.member', 'cors']], function () {
    Route::group(['prefix' => 'user'], function () {
        Route::post('moreinfo', 'API\AuthController@moreinfo');
    });
