...
class Member extends Model implements HasMediaConversions, AuthenticatableContract
{
    use Authenticatable, CanResetPassword, EntrustUserTrait, HasMediaTrait,Eloquence;
