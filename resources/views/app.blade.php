    ...
    <div class="leftside hidden-print">
        <div class="sidebar">
            ...
            <ul class="nav-sidebar">
                ...
                <li class="nav-dropdown {{ Utilities::setActiveMenu('members*',true) }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Utilities::setActiveMenu('members/inactive') }}"><a
                                    href="{{ action('MembersController@inactive') }}">Inactive Members</a></li>
                    </ul>
                </li>
                @endpermission
                ...
                <li class="nav-dropdown {{ Utilities::setActiveMenu('subscriptions*',true) }}">
                    ...
                    <ul>
                        <li class="{{ Utilities::setActiveMenu('subscriptions/all') }}"><a
                                    href="{{ action('SubscriptionsController@index') }}">All Subscriptions</a></li>
                        @permission(['manage-gymie','manage-subscriptions','add-subscription'])
                        <li class="{{ Utilities::setActiveMenu('subscriptions/create') }}"><a
                                    href="{{ action('SubscriptionsController@create') }}">Add Subscription</a></li>
                        @endpermission
                        <li class="{{ Utilities::setActiveMenu('subscriptions/expiring') }}"><a
                                    href="{{ action('SubscriptionsController@expiring') }}">Expiring Subscriptions</a>
                        </li>
                        <li class="{{ Utilities::setActiveMenu('subscriptions/expired') }}"><a
                                    href="{{ action('SubscriptionsController@expired') }}">Expired Subscriptions</a>
                        </li>
                    </ul>
                </li>
                @endpermission
                ...
                <li class="nav-dropdown {{ Utilities::setActiveMenu('invoices*',true) }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Utilities::setActiveMenu('invoices/unpaid') }}"><a
                                    href="{{ action('InvoicesController@unpaid') }}">Unpaid Invoices</a></li>
                        <li class="{{ Utilities::setActiveMenu('invoices/partial') }}"><a
                                    href="{{ action('InvoicesController@partial') }}">Partial Invoices</a></li>
                        <li class="{{ Utilities::setActiveMenu('invoices/overpaid') }}"><a
                                    href="{{ action('InvoicesController@overpaid') }}">Overpaid Invoices</a></li>
                    </ul>
                </li>
                @endpermission
                ...
                <li class="nav-dropdown {{ Utilities::setActiveMenu('expenses*',true) }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Utilities::setActiveMenu('expenses/categories/all') }}"><a
                                    href="{{ action('ExpenseCategoriesController@index') }}">Expense Categories</a></li>
                        @endpermission
                        ...
                        <li class="{{ Utilities::setActiveMenu('expenses/categories/create') }}"><a
                                    href="{{ action('ExpenseCategoriesController@create') }}">Add Category</a></li>
                        @endpermission
                    </ul>
                </li>
                @endpermission
                ...
                <li class="nav-dropdown {{ Utilities::setActiveMenu('plans*',true) }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Utilities::setActiveMenu('plans/services/all') }}"><a
                                    href="{{ action('ServicesController@index') }}">Gym Services</a></li>
                        @endpermission
                        @permission(['manage-gymie','manage-services','add-service'])
                        <li class="{{ Utilities::setActiveMenu('plans/services/create') }}"><a
                                    href="{{ action('ServicesController@create') }}">Add Service</a></li>
                        @endpermission
                    </ul>
                </li>
                @endpermission
                ...
                <li class="nav-dropdown {{ Utilities::setActiveMenu('user*',true) }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ Utilities::setActiveMenu('user/create') }}"><a
                                    href="{{ action('AclController@createUser') }}"><i class="fa fa-list"></i> Add new
                                user</a></li>
                        <li class="{{ Utilities::setActiveMenu('user/role') }}"><a
                                    href="{{ action('AclController@roleIndex') }}"><i class="fa fa-list"></i> Roles</a>
                        </li>
                        @role('Gymie')
                ...
                @permission(['manage-gymie','manage-users'])
                <li class="nav-dropdown {{ Utilities::setActiveMenu('mobile*',true) }}">
                    <a href="#">
                        <i class="fa fa-mobile"></i> <span>Mobile</span>
                    </a>
                    <ul>
                        <li class="{{ Utilities::setActiveMenu('mobile/settings*') }}"><a
                                    href="{{ action('MobileController@settings') }}"> Settings</a></li>

                        <li class="nav-dropdown {{ Utilities::setActiveMenu('mobile/onboarding*',true) }}">
                            <a href="#"><span>Onboarding</span>
                            </a>
                            <ul>
                                <li class="{{ Utilities::setActiveMenu('mobile/onboarding*') }}"><a
                                            href="{{ action('OnboardingController@index') }}">All</a></li>
                            </ul>
                        </li>
